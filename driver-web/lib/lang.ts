...
// Reviewed Rwanda-facing translations for the core driver dashboard.
Object.assign(DRIVER_UI, {
  'Go Online': { en: 'Go Online', fr: 'Se connecter', rw: 'Jya ku murongo' },
  'Go Offline': { en: 'Go Offline', fr: 'Se déconnecter', rw: 'Va ku murongo' },
  'You are online': { en: 'You are online', fr: 'Vous êtes en ligne', rw: 'Uri ku murongo' },
  'You are offline': { en: 'You are offline', fr: 'Vous êtes hors ligne', rw: 'Ntabwo uri ku murongo' },
  'Earnings': { en: 'Earnings', fr: 'Revenus', rw: 'Amafaranga winjije' },
  'Today': { en: 'Today', fr: 'Aujourd’hui', rw: 'Uyu munsi' },
  'All time': { en: 'All time', fr: 'Depuis toujours', rw: 'Igihe cyose' },
  'Trips': { en: 'Trips', fr: 'Trajets', rw: 'Ingendo' },
  'Accept': { en: 'Accept', fr: 'Accepter', rw: 'Emera' },
  'Decline': { en: 'Decline', fr: 'Refuser', rw: 'Wanga' },
  "I've Arrived": { en: "I've Arrived", fr: 'Je suis arrivé', rw: 'Nageze aho ndi' },
  ...
  'Heading to pickup': { en: 'Heading to pickup', fr: 'En route vers le point de prise en charge', rw: 'Ngiye aho gutorera umugenzi' },
  'Waiting for passenger': { en: 'Waiting for passenger', fr: 'En attente du passager', rw: 'Ntegereje umugenzi' },
  'Trip in progress': { en: 'Trip in progress', fr: 'Trajet en cours', rw: 'Urugendo rurakomeje' },
  'New ride request': { en: 'New ride request', fr: 'Nouvelle demande de trajet', rw: 'Ubusabe bushya bw’urugendo' },
  'Fare': { en: 'Fare', fr: 'Tarif', rw: 'Ikiguzi' },
  'Rides only': { en: 'Rides only', fr: 'Trajets uniquement', rw: 'Ingendo gusa' },
  'Deliveries only': { en: 'Deliveries only', fr: 'Livraisons uniquement', rw: 'Kohereza gusa' },
  'Both': { en: 'Both', fr: 'Les deux', rw: 'Byombi' },
  'Earnings & Wallet': { en: 'Earnings & Wallet', fr: 'Revenus et portefeuille', rw: 'Amafaranga winjije n’ikofi' },
  'Balance owed to Zana': { en: 'Balance owed to Zana', fr: 'Solde dû à Zana', rw: 'Amafaranga ubereyemo Zana' },
  'Available to withdraw': { en: 'Available to withdraw', fr: 'Disponible au retrait', rw: 'Amafaranga ushobora kubikuza' },
  "Today's earnings": { en: "Today's earnings", fr: 'Revenus du jour', rw: 'Amafaranga winjije uyu munsi' },
  'Cash collected today': { en: 'Cash collected today', fr: 'Espèces encaissées aujourd’hui', rw: 'Amafaranga wakiriye uyu munsi' },
  ...
  'Withdraw': { en: 'Withdraw', fr: 'Retirer', rw: 'Kubikuza' },
  'Payment received': { en: 'Payment received', fr: 'Paiement reçu', rw: 'Ubwishyu bwakiriwe' },
  'Payment didn\'t go through': { en: "Payment didn't go through", fr: "Le paiement n’a pas abouti", rw: 'Ubwishyu ntibwagenze' },
  ...
  'Rating': { en: 'Rating', fr: 'Note', rw: 'Amanota' },
  'Member since': { en: 'Member since', fr: 'Membre depuis', rw: 'Umunyamuryango kuva' },
  'Recent ratings from passengers': { en: 'Recent ratings from passengers', fr: 'Évaluations récentes des passagers', rw: 'Amanota aheruka gutangwa n’abagenzi' },
  'Language': { en: 'Language', fr: 'Langue', rw: 'Ururimi' },
  ...
  'You cancelled': { en: 'You cancelled', fr: 'Vous avez annulé', rw: 'Wahagaritse' },
