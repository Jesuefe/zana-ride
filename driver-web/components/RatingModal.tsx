    ...
    <div className="fixed inset-0 z-50 flex items-end bg-black/50">
      <div className="w-full bg-white rounded-t-2xl p-6 animate-fade-slide-up">
        <div className="flex items-center justify-between mb-5">
          <h2 className="text-lg font-bold text-gray-900">{dt('Rate your ride')}</h2>
        ...
        {done ? (
          <div className="text-center py-4">
            ...
            <p className="font-semibold text-gray-900">{dt('Thanks for rating')} {driverName}!</p>
          </div>
        ) : (
          <>
            <p className="text-sm text-gray-500 mb-4 text-center">{dt('How was your ride with')} <strong>{driverName}</strong>?{dt('?')}</p>
            ...
            {score > 0 && (
              <>
                ...
                <textarea
                  ...
                  placeholder={dt('Add a comment (optional)')}
                  rows={2}
            ...
            >
              ...
              {submitting ? dt('Submitting…') : dt('Submit Rating')}
            </button>
