...
export default function MerchantsPage() {
  ...
  useEffect(() => {
    load();
    // Previously required a manual reload to see a merchant that just
    // registered — no WebSocket event exists anywhere for merchant
    // registration, and inventing one wasn't justified by anything the
    // audit actually found, so a reasonable poll is the correctly-scoped
    // fix here rather than new infrastructure. Slower than the orders
    // page on purpose — a new registration isn't minute-sensitive the
    // way a live order is.
