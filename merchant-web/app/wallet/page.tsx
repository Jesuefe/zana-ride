...
export default function WalletPage() {
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      setSuccess(`${amt.toLocaleString()} RWF withdrawal submitted`);
    ...
    <>
      ...
      <div className="p-6 space-y-5 max-w-2xl">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-gray-100"><p className="font-bold text-gray-900">Transaction History</p></div>
          {!wallet?.transactions?.length ? <p className="text-sm text-gray-400 text-center py-8">No transactions yet.</p> :
