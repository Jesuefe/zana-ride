  ...
  return (
    <div className="p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <div className="flex items-center gap-3 mb-3"><AlertTriangle size={20} className="text-amber-500" /><h2 className="font-semibold text-gray-900">{t('SOS Feature')}</h2></div>
          <p className="text-sm text-gray-500">{t('During any active ride, shake your phone or tap the SOS button to report a safety concern. Our team will be alerted immediately.')}</p>
        </div>
      </div>
    </div>
  );
